...
func TestRequestServing(t *testing.T) {
	...
	if testConn.Out.String() != "HTTP/1.0 404 Not found\r\n\r\n" {
...
func TestRequestHandler(t *testing.T) {
	...
	drh.ServeRequest = func(c net.Conn, path string, metaDataSupport bool, offset int) {
		rpath = path
	...
	if rpath != "/mylist" || rmetaDataSupport != true || roffset != 0 {
	...
	if rpath != "/mylist2" || rmetaDataSupport != true || roffset != 656 {
		t.Error("Unexpected request decoding result:", rpath, rmetaDataSupport, roffset)
		return
	}
